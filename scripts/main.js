...
function select_idx(query) {
    ...
    switch (query.idx.value) {
        case "full-a":
            return build_query("http://covid19papers.njit.edu/api/index/full", {
                key: "abstract",
                query: querystr,
            })
        case "full-b":
        ...
        case "detail":
            return build_query("http://covid19papers.njit.edu/api/index/detail", {
                query: querystr,
            })
        case "ft":
            return build_query("http://covid19papers.njit.edu/api/index/ft", {
                query: querystr,
            })
        case "title":
            return build_query("http://covid19papers.njit.edu/api/index/tp", {
                index: "cordf",
                key: "title",
                query: querystr,
            })
